<p align="center">
<a href="https://www.npmjs.com/package/wechat-pay-v3-o"><img src="https://img.shields.io/npm/v/wechat-pay-v3-o.svg" alt="npm package"></a>
</p>
...
```dash
npm install wechat-pay-v3-o
```


## 说明
**代码扩展自 [wechat-pay-v3](https://www.npmjs.com/package/wechat-pay-v3)， 增加了企业付款 能力，其他无改变，-o 为 优化的意思，也有噌 gpt-4o 的 o 的意思，不重要！！！**
...
```typescript
import { apiContainer, ContainerOptions, Applyment } from 'wechat-pay-v3-o'
...
```typescript
import { apiContainer } from 'wechat-pay-v3-o'
...
```typescript
import { WechatPayV3Base } from 'wechat-pay-v3-o'
